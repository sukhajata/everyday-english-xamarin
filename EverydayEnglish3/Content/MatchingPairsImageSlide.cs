...
{
    public class MatchingPairsImageSlide : ContentPage
    {
        ...
        public MatchingPairsImageSlide(List<Media> _mediaList, string _instructions)
        {
        ...
        private void CreateTextFrame(Media media, int col, int row)
        {
            ...
            lbl.Style = (Style)App.Current.Resources["labelStyle"];
